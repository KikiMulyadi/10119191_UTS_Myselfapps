...
import com.example.a10119191_uts_myselfapp.dailyactivity.Daily;
import com.example.a10119191_uts_myselfapp.dailyactivity.Daily_Adapter;
import com.example.a10119191_uts_myselfapp.dailyactivity.Daily_Data;
import com.example.a10119191_uts_myselfapp.dailyactivity.Friendlist_Adapter;
import com.example.a10119191_uts_myselfapp.dailyactivity.Friends;
import com.example.a10119191_uts_myselfapp.dailyactivity.Friends_Data;
import com.example.a10119191_uts_myselfapp.gallery.Gallery_Adapter;
import com.example.a10119191_uts_myselfapp.gallery.Gallery_Item;
import com.example.a10119191_uts_myselfapp.music.Music_Adapter;
import com.example.a10119191_uts_myselfapp.music.Music_Data;
import com.example.a10119191_uts_myselfapp.music.Music_Item;
...
public class Menu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        whatsapp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotolink("https://wa.me/6285722642719");
            }
        });
        ...
        instagram.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotolink("https://www.instagram.com/kiki_3393/");
            }
        });
        ...
        navigation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotolink("https://goo.gl/maps/iHYTrxTmoxRZN2JF8");
            }
        });
